  ...
  return (
    <div className="fixed inset-0 bg-black/60 z-[70] flex justify-center items-start p-4 overflow-auto">
      <div className="bg-white dark:bg-slate-900 rounded-xl shadow-xl w-full max-w-3xl my-4">
        {/* Header */}
        <div className="bg-white dark:bg-slate-900 rounded-t-xl border-b border-slate-200 dark:border-slate-700 px-6 py-4 print:hidden">
          <div className="flex justify-between items-center">
            ...
            <div className="flex items-center gap-3">
              ...
              <button
                ...
                className="flex items-center gap-2 px-4 py-2 bg-slate-900 hover:bg-slate-800 disabled:bg-slate-400 text-white font-medium rounded-lg transition-colors"
              >
